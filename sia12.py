...
pizzaMenu = ["Pepperoni", "Hawaiian", "Cheese", "Italian", "Margherita",
             "Apricot Chicken", "BBQ MeatLovers", "Chicken and Cranberry"]
...
def pic_or_deli():
    ...
    if delivery == "D":
        ...
        while running == True:
            ...
            # User has not inputted anything, therefore invalid input
        ...
        while running == True:
            ...
            house_no = input("House number:")
                    # Checks whether input is numbers only
        ...
        while running == True:
            ...
            street_name= input("Street name:")
                    # Checks whether input is letters only
        ...
        while running == True:
            ...
            if not re.match("^[0-9 ]*$", customer_telephone):
                ...
                break #Breaks the loop when valid input has been
...
def order():
    ...
    while True:
        try: #Validating inputs 
            ...
            if pizza_no< 1:
                print("Please order between 1 - 5 pizzas") #Checks whether input is between 1 and 5 continue
            elif pizza_no> 5:
                print("Please orderbetween 1 - 5 pizzas")
                continue
            else:
                break #Breaks the loop when valid input has been entered
        except ValueError: #Validating inputs - accepts only numbers and can't be leftblank
            print("Please use numbers only")
            continue
...
def Choice_of_pizza():
    ...
    global grandTotal
        ...
        except ValueError: #Validating inputs - accepts only numbers and can't be left
            print("Please use numbers only")
            continue
...
def order_some_more():
    ...
    '''cost[:] = []'''
    if order_more == "Z": 
        print_menu() #Calls the functions - will run the code that the 
...
def defines():
    ...
    confirm()
    print ("")
    print ("THANK YOU FOR YOUR ORDER") if delivery == "D":
    print ("Your order will be delivered in 25mins") #Ending statement
    elif delivery == "P": print ("Your order will be ready to pick up in 20mins") #Ending statement

    elif order_more == "X":
        print ("")
        print ("THANK YOU FOR YOUR ORDER") if delivery == "D":
        print ("Your order will be delivered in 25mins") #Ending statement
    elif delivery == "P": print ("Your order will be ready to pick up in 20mins") #Ending statement else:
